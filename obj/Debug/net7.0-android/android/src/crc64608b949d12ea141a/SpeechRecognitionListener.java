...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.Maui.AudioRecorder.SpeechRecognitionListener, Plugin.Maui.AudioRecorder", SpeechRecognitionListener.class, __md_methods);
	}
	...
	public SpeechRecognitionListener ()
	{
		...
		if (getClass () == SpeechRecognitionListener.class) {
			mono.android.TypeManager.Activate ("Plugin.Maui.AudioRecorder.SpeechRecognitionListener, Plugin.Maui.AudioRecorder", "", this, new java.lang.Object[] {  });
		}
	}
